...
namespace BestStoreMVC.Migrations
{
    ...
    [Migration("20241014074342_EditRequestItems")]
    partial class EditRequestItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BestStoreMVC.Models.RequestItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RequestUserUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BestStoreMVC.Models.RequestItems", b =>
                {
                    b.HasOne("BestStoreMVC.Models.Product", "RequestProduct")
                        .WithMany()
                        .HasForeignKey("RequestProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("User", "RequestUser")
                        .WithMany()
